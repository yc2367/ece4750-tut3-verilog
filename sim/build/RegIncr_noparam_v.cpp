...
VRegIncr_noparam_t * create_model( const char *vcd_filename ) {
  ...
  m     = (VRegIncr_noparam_t *) malloc( sizeof(VRegIncr_noparam_t) );
  model = new VRegIncr_noparam();
...
void destroy_model( VRegIncr_noparam_t * m ) {

  #if VM_COVERAGE
    VerilatedCov::write( "coverage.dat" );
  #endif

  VRegIncr_noparam * model = (VRegIncr_noparam *) m->model;
...
void comb_eval( VRegIncr_noparam_t * m ) {
...
void seq_eval( VRegIncr_noparam_t * m ) {
...
#if VLINETRACE
void trace( VRegIncr_noparam_t * m, char* str ) {
